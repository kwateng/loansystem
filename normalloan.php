...
if(!empty($_POST))
{
    ...
    if(count($errors)==0) {
        ...
        $loan->addNewNormalLoan();
        $loan_id=$loan->addGeneralLoan();
        if($loan_id==null)
        {
           $errors[] = "Fail to add loan";
        } else {
            header("Location: view_ordinary_loan.php?loan_id=".$loan_id);
        }
    }
}
?>
...
<div id="main">
    ...
    <div id="site_content">
        ...
        <div id="content">
            ...
            <h3 align="center">Place Ordinary Loan</h3>
            <form method="post">
                <div class="form_settings">
                    ...
                    <p><span>Gurantor ID 2</span><input class="contact" type="text" name="gurantor_id_2" /></p>
