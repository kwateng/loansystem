    ...
    <div id="site_content">
        ...
        <div id="content">
            ...
            if(isAdmin($loggedInUser->user_id) || isManager($loggedInUser->user_id)){
                    echo "<a href='edit_ordinary_loan.php?loan_id=".$loan->loan_id."' class='linkb'>Edit loan</a>";
            } else if(isAccountant($loggedInUser->user_id)) {
                        echo "<a href='edit_ordinary_loan_accountant.php?loan_id=".$loan->loan_id."' class='linkb'>Edit loan</a>";
            }
            ?>
                </div>
            </form>
