...
if(!empty($_POST))
{
    ...
    $sub_type = trim($_POST["distress_types"]);
    ...
    if(count($errors)==0) {
        ...
        $loan->addNewDistressLoan($sub_type);
        $loan_id=$loan->addGeneralLoan();
        if($loan_id==null)
        {
            $errors[] = "Fail to add loan";
        } else {
            header("Location: view_distress_loan.php?loan_id=".$loan_id);
        }
    }
}
?>
...
<div id="main">
    ...
    <div id="site_content">
        ...
        <div id="content">
            ...
            <h3 align="center">Place Distress Loan</h3>
            <form method="post">
                <div class="form_settings">
                    <p><span>Loan Type</span><select name="distress_types">
