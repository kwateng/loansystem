...
if(!empty($_POST)) {
    ...
    header("Location: view_distress_loan.php?loan_id=".$id);
}
...
<div id="main">
    ...
    <div id="site_content">
        ...
        <div id="content">
            <h3>Edit Distress Loan: Member_ID-<a href="account/view_account.php?employee_id=<?=$loan->member_id?>"><?=$loan->member_id?></a></h3>
            <form method="post">
