...
$lang = array_merge($lang,array(
	...
	%m1%activate-myaccount.php?token=%m2%",
...
$lang = array_merge($lang,array(
    "SAME GUARANTOR ID" => "Please specify different guarantors",
    "GUARANTOR 1 ID NOT EXIST" => "Guarantor 1 is not exist in the system",
    "GUARANTOR 2 ID NOT EXIST" => "Guarantor 2 is not exist in the system",
));
