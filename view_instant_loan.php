...
<div id="main">
    ...
    <div id="site_content">
        ...
        <div id="content">
            <h3>Ordinary Loan Details: Member_ID-<a href="account/view_account.php?employee_id=<?=$loan->member_id?>"><?=$loan->member_id?></h3>
            <form method="post">
                <div class="form_settings">
                    ...
                    if(isAdmin($loggedInUser->user_id) || isManager($loggedInUser->user_id)){
                        echo "<a href='edit_instant_loan.php?loan_id=".$loan->loan_id."' class='linkb'>Edit loan</a>";
                    } else if(isAccountant($loggedInUser->user_id)) {
                        echo "<a href='edit_instant_loaned_accountant.php?loan_id=".$loan->loan_id."' class='linkb'>Edit loan</a>";
                    }
                    ?>
                </div>
            </form>
